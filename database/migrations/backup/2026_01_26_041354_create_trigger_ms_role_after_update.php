...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE TRIGGER `tg_ms_role_AFTER_UPDATE` AFTER UPDATE ON `ms_role` FOR EACH ROW 
            BEGIN
                ...
                SET v_screen_id = IFNULL(SUBSTRING_INDEX(OLD.role_id, '-', 1), '');
    ...
    {
        DB::unprepared("DROP TRIGGER IF EXISTS `tg_ms_role_AFTER_UPDATE`");
    }
};
