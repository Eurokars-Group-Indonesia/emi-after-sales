...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            DROP PROCEDURE IF EXISTS sp_add_ms_brand;

            CREATE PROCEDURE sp_add_ms_brand(
            ...
            BEGIN
                ...
                DECLARE v_screen_id VARCHAR(25) DEFAULT 'MBD01';
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS sp_add_ms_brand");
    }
};
