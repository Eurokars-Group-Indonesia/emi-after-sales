...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE TRIGGER `tg_ms_role_menus_AFTER_UPDATE` AFTER UPDATE ON `ms_role_menus` FOR EACH ROW 
            BEGIN
                ...
                SET v_new_response = CONCAT(
                    ...
                    '  \"menu_id\": \"', IFNULL(NEW.menu_id, ''), '\",', CHAR(10),
    ...
    {
        DB::unprepared("DROP TRIGGER IF EXISTS `tg_ms_role_menus_AFTER_UPDATE`");
    }
};
