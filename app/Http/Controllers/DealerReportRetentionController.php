...
class DealerReportRetentionController
{
    protected $modelRepo;
    ...
    {
        // $data['dataDealer'] = DB::connection('db_wrs_aftersales')
        //                         ->table('tbldealer')
        //                         ->where('is_active', true)
        //                         ->orderBy('nm_dealer')->get();
        ...
        return view('dealer.report_retention.index', $data);
    }
    ...
    public function retrieve(Request $request)
    {
        ...
        // kd_dealer
        $kd_dealer = DB::table('tbldealer')
                        ->where('kd_dealer', session('user.kd_dealer'))
                        ->pluck('kd_dealer')
                        ->toArray();
        // dd($kd_dealer);
