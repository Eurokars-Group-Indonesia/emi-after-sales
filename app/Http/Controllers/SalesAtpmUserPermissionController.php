...
class SalesAtpmUserPermissionController
{
    public function index()
    {
        return view('sales.atpm.page_user_permission.index');
    }

    // public function user_permission_datatable()
    // {
    //     $query = DB::table('sales_atpm_user')->get();
    //     // dd($query);
    ...
    //             $action .= '<a href="'.route('sales.atpm.user_menu_index').'" class="btn btn-xs-mzd btn-primary">Menu</a>';
    //             $action .= '<a href="'.route('sales.atpm.user_permission_index').'" class="btn btn-xs-mzd btn-primary">Permission</a>';
