...
use App\Repositories\SalesAtpmMasterMenuRepository;

class SalesAtpmSystemSetupMasterMenuController
{
    protected $SalesAtpmMasterMenuRepo;

    public function __construct(SalesAtpmMasterMenuRepository $SalesAtpmMasterMenuRepository)
    {
        $this->SalesAtpmMasterMenuRepo = $SalesAtpmMasterMenuRepository;
    }
    ...
    public function sales_atpm_master_menu_datatable(Request $request)
    {
        ...
        $query = $this->SalesAtpmMasterMenuRepo->findAll($srcText);
        // dd($query);
