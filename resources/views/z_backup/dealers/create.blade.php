    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-shop"></i> Create New Dealer
            </div>
            <div class="card-body">
                <form action="{{ route('dealers.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('dealer_code') is-invalid @enderror" 
                                   name="dealer_code" value="{{ old('dealer_code') }}" required maxlength="50">
                            @error('dealer_code')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('dealer_name') is-invalid @enderror" 
                                   name="dealer_name" value="{{ old('dealer_name') }}" required maxlength="150">
                            @error('dealer_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror" 
                                   name="city" value="{{ old('city') }}" maxlength="100">
                            @error('city')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save"></i> Save Dealer
                        </button>
                    </div>
                </form>
            </div>
