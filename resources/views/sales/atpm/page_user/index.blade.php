...
@php
    ...
    $breadcrumbs = [
        ...
        ['title' => 'Sales ATPM User', 'url' => 'javascript:void(0)'],
    ];
@endphp
...
@section('content')
    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">Sales ATPM User</div>
                    ...
                    <table id="customer-table" class="table table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Kd ATPM User</th>
    ...
    <script>
        $(function () {
            ...
            const dt = $('#customer-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("sales.atpm.user_datatable") }}',
                ...
                columns: [
                    ...
                    { data: 'kd_atpm_user', name: 'kd_atpm_user' },
            ...
            $('body').on('click', '#btn-sync-user', function(){
                $('#disabler').show();

                axios.get('{{ route('sales.atpm.user_sync') }}', {
