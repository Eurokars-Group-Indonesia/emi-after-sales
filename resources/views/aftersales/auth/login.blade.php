...
<div class="page-wrap">
    ...
    {{-- Top bar --}}
    <div class="top-bar">
        <img src="{{ asset('logo.png') }}" alt="EMI After Sales" style="height:100px;">
    ...
    <div class="center-area">
        <div class="login-card">
            ...
            <div class="card-form">
                ...
                <form action="{{ route('aftersales.login.auth') }}" method="post">
                    @csrf
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4" style="margin-top:10px;">
                       <p class="form-check-label">Please using your WRS After Sales Account</p>
                    </div>
                </form>
            </div>
