        ...
        <div class="row g-4">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('aftersales.atpm.model_other_create') }}" class="btn btn-primary btn-sm" id="btn-model-other"> 
    ...
    <script>
        ...
        $(function () {
            ...
            $('#model-other-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("aftersales.atpm.model_other_datatable") }}',
                columns: [
            ...
            $('body').on('click', '#btn-sync-atpm-user', function(){
                ...
                axios.get('{{ route('aftersales.atpm.atpm_user_sync') }}',{
                            headers: {
